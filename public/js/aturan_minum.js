...
function searchAjax(key = 0) {
	...
	var aturan_minum                = $('#aturan_minum').val();
	var displayed_rows         = $('#displayed_rows').val();

	$.get(base + '/home/aturan_minum/search/ajax',
		{
