...
function searchAjax(key = 0) {
	...
	var coa                = $('#coa').val();
	var kelompok_coa                = $('#kelompok_coa').val();
	var displayed_rows         = $('#displayed_rows').val();

	$.get(base + '/home/coa/search/ajax',
		{
			'coa':            coa,
