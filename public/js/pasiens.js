        ...
        $('#submitPasien').click(function(e){
            ...
            if($('#pasienInsertForm input[name="nama"]').val() == '' || $('#pasienInsertForm select[name="sex"]').val() == '' || $('#pasienInsertForm select[name="panggilan"]').val() == ''){
                ...
                $.post(url, data, function(result) {
                    ...
                    temp += "&nbsp;&nbsp;&nbsp;<a data-value=\"pasiens/" + result[0].id + "\" style=\"color: orange; font-size: large;\" data-toggle=\"tooltip\" data-placement=\"bottom\" href=\"" + base + "/home/pasiens/" + result[0].id + "/riwayat\" title=\"Klik untuk melihat riwayat pasien\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"></span></a></td>";
                   temp += "</tr>";
